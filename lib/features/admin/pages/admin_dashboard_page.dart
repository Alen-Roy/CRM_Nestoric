            ...
            child: Row(
              children: _stages.map((s) {
                ...
                return Expanded(
                  ...
                  child: Container(
                    height: 12,
                    color: _colors[s] ?? AppColors.primaryMid,
                  ),
                );
              }).toList(),
            ),
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      ' logged a ${entry.activity.type.label.toLowerCase()}',
                                ),
                              ],
                            ),
                          ),
    ...
    return summariesAsync.when(
      ...
      data: (summaries) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (_, i) =>
              _WorkerCard(summary: summaries[i], rank: i + 1),
        );
      },
    );
  }
...
class _WorkerCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final activeSession = ref
        .watch(workerSessionStreamProvider(summary.userId))
        .value;
          ...
          children: [
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    '${summary.winRate.toStringAsFixed(0)}% win',
                    style: const TextStyle(
                      color: AppColors.success,
                      fontSize: 12,
                      fontWeight: FontWeight.w700,
            ...
            Row(
              children: [
                ...
                _statChip(
                  Symbols.task_alt,
                  '${summary.tasksCompleted}/${summary.tasks.length}',
...
class _AllClientsTabState extends ConsumerState<_AllClientsTab> {
  ...
  static const _statusColors = {
    ...
    'Completed': AppColors.primaryMid,
  };
    ...
    return clientsAsync.when(
      ...
      data: (clients) {
        final filtered = _statusFilter == 'All'
            ? clients
            : clients.where((c) => c.status == _statusFilter).toList();
            ...
            Expanded(
              child: filtered.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (_, __) => const SizedBox(height: 10),
                      itemBuilder: (_, i) =>
                          _ClientListTile(client: filtered[i]),
                    ),
            ),
          ],
        );
                ...
                onTap: () {
                  ...
                  if (client.id != null) {
                    ref
                        ...
                        .changeClientStatus(client.id!, s);
                  }
                },
                child: Container(
                  width: double.infinity,
      ...
      onTap: user.isAdmin
          ...
          : () => Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => WorkerReportPage(
                  userId: user.uid,
                  workerName: user.name?.isNotEmpty == true
                      ? user.name!
                      : user.email,
                ),
              ),
              ...
              child: Center(
                child: Text(
                  ((user.name?.isNotEmpty == true ? user.name! : user.email)[0])
                      .toUpperCase(),
                  style: TextStyle(
                    color: user.isAdmin ? AppColors.primary : AppColors.textMid,
                    fontSize: 18,
                    fontWeight: FontWeight.w800,
                  ),
                ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            const Text(
              'Create a worker or manager account.',
    ...
    try {
      await ref
          ...
          .assignTaskToWorker(
            ...
            adminNote: _adminNoteCtrl.text.trim().isEmpty
                ? null
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _sheetField(
                _adminNoteCtrl,
                'Any extra instructions for them...',
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Tap + New Notice to post one to all workers',
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: item.isPinned ? AppColors.primarySoft : AppColors.border,
        ),
        boxShadow: [
          BoxShadow(
            color: AppColors.primary.withValues(alpha: 0.07),
          ...
          Row(
            children: [
              ...
              GestureDetector(
                ...
                child: Icon(
                  item.isPinned ? Symbols.push_pin : Symbols.push_pin,
                  color: item.isPinned
                      ? AppColors.primary
                      : AppColors.textLight,
                  size: 18,
          ...
          Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    item.adminName.isNotEmpty
                        ? item.adminName[0].toUpperCase()
                        : 'M',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 11,
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'This notice will be removed for all workers.',
          style: TextStyle(color: AppColors.textMid),
        ),
        actions: [
          TextButton(
    ...
    try {
      ...
      await ref
          ...
          .post(
            ...
            adminUid: user?.uid ?? '',
            adminName:
                user?.displayName ?? user?.email?.split('@').first ?? 'Manager',
            pinned: _pinned,
          );
      if (!mounted) return;
      Navigator.pop(context);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            const Text(
              'Visible to all workers on their home screen',
              style: TextStyle(color: AppColors.textMid, fontSize: 13),
            ),
            const SizedBox(height: 20),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: _pinned ? AppColors.primarySoft : AppColors.border,
                  ),
                ),
                child: Row(
                  children: [
                    Icon(
                      Symbols.push_pin,
                      color: _pinned ? AppColors.primary : AppColors.textLight,
                      size: 18,
                    ),
                    const SizedBox(width: 10),
                    Text(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Long-press to copy, then paste in Google Maps.',
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      const Text(
                        'Nobody has checked in for this date.',
                        style: TextStyle(
                          color: AppColors.textLight,
                          fontSize: 13,
                        ),
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              'Long-press above to copy, then paste in Google Maps.',
              style: TextStyle(color: AppColors.textLight, fontSize: 11),
              textAlign: TextAlign.center,
            ),
          ],
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 3),
                    Text(
                      _timeFmt.format(record.checkInTime),
                      style: const TextStyle(
                        color: AppColors.textMid,
                        fontSize: 11,
                      ),
                    ...
                    if (record.hasCheckedOut) ...[
                      ...
                      const SizedBox(width: 3),
                      Text(
                        _timeFmt.format(record.checkOutTime!),
                        style: const TextStyle(
                          color: AppColors.textMid,
                          fontSize: 11,
                        ),

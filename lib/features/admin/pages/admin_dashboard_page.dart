...
class _AdminTabBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final labels = ['Overview', 'Leads', 'Workers', 'Clients', 'Users', 'Notices'];
    final icons  = [Symbols.dashboard, Symbols.leaderboard, Symbols.groups, Symbols.business, Symbols.manage_accounts, Symbols.campaign];
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                SizedBox(width: 8),
                Text('Assign Work', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w700)),
              ]),
            ),
          ),
          const SizedBox(height: 14),

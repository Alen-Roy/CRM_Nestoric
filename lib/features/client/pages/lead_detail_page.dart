...
class _LeadDetailPageState extends ConsumerState<LeadDetailPage> {
              ...
              IconButton(
                ...
                onPressed: () async {
                  final updated = await Navigator.push<LeadModel>(
                    context,
                    MaterialPageRoute(
                      builder: (_) => EditLeadPage(lead: _lead),
                    ),
                  );
                  if (updated != null && mounted)
                    setState(() => _lead = updated);
              ...
              background: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      _stageColor(_lead.stage),
                      _stageColor(_lead.stage).withOpacity(0.7),
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                ...
                child: SafeArea(
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(20, 62, 20, 14),
                    child: Column(
                  ...
                  child: _infoGroup([
                    ...
                    _tappableInfoRow(
                      ...
                      onTap: (_lead.email != null && _lead.email!.isNotEmpty)
                          ...
                          : null,
                      valueColor:
                          (_lead.email != null && _lead.email!.isNotEmpty)
  ...
  // ── Compact icon-only action button (used as trailing in info rows) ─────────
...
class _EditableNotesCardState extends ConsumerState<_EditableNotesCard> {
  ...
  Future<void> _save() async {
    ...
    await ref
        ...
        .updateNotes(widget.lead, newNotes);
    setState(() => _editing = false);
    widget.onSaved(
      widget.lead.copyWith(notes: newNotes.isEmpty ? null : newNotes),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!_editing)
            Text(
              widget.lead.notes?.isEmpty ?? true
              ...
              style: TextStyle(
                ...
                height: 1.55,
                fontStyle:
                    (widget.lead.notes == null || widget.lead.notes!.isEmpty)
                    ? FontStyle.italic
                    : FontStyle.normal,
              ),
            )
                        ...
                        children: [
                          ...
                          Text(
                            isThisLead
                                ...
                                : inOther
                                ? 'You are already in a meeting for another lead'
...
/// Shown inside the lead detail header — premium card with action buttons.
      ...
      child: Row(
        children: [
          ...
          _HeroContactBtn(
            ...
            enabled: hasPhone,
            onTap: hasPhone
                ? () => _launchContactUrl(context, 'tel:$cleanPhone')
                : null,
          ),
          const SizedBox(width: 8),
          // ── WhatsApp button ──────────────────────────────────────────────
          ...
          _HeroContactBtn(
            ...
            enabled: hasPhone,
            onTap: hasPhone
                ? () => _launchContactUrl(context, 'sms:$cleanPhone')
                : null,
          ),
        ],
      ),
...
/// Individual hero contact button shown inside _QuickContactBar.

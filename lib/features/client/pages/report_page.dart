...
final _allActivitiesProvider = StreamProvider<List<Map<String, dynamic>>>((
  ref,
) {
...
_ReportData _compute(
  ...
  final maxRevenue = monthRevenue.isEmpty
      ? 10.0
      : (monthRevenue.reduce((a, b) => a > b ? a : b) * 1.25).clamp(
          10.0,
          double.infinity,
        );
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        '${data == null ? 'N/A' : leads.where((l) => l.stage == 'Won').length.toString()} Won Deals',
                  ...
                  Text(
                    data == null ? '—' : fmtMoney(data.totalRevenue),
                    style: const TextStyle(
                      color: AppColors.textDark,
                      fontSize: 46,
                      fontWeight: FontWeight.w800,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    data == null ? '—' : fmtMoney(data.totalRevenue * 3),
                    style: const TextStyle(
                      color: AppColors.textDark,
                      fontSize: 32,
                      fontWeight: FontWeight.w800,
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      value: data == null
                          ? 0
                          : ((data.totalRevenue / (data.totalRevenue * 3 + 1))
                                .clamp(0.0, 1.0)),
                  ...
                  Row(
                    children: [
                      _dot(
                        AppColors.primary,
                        'Earned ${data == null ? "0" : (data.totalRevenue / (data.totalRevenue * 3 + 1) * 100).toStringAsFixed(0)}%',
                      ),
                      const Spacer(),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        _kpiCard(
          'Win Rate',
          data == null ? '—' : '${data!.winRate.toStringAsFixed(0)}%',
          AppColors.primary,
        ),
        const SizedBox(width: 10),
        _kpiCard(
          'Avg Deal',
          data == null ? '—' : fmtMoney(data!.avgDealSize),
          AppColors.primary,
        ),
        const SizedBox(width: 10),
        _kpiCard(
          'Lost',
          data == null ? '—' : '${data!.lostLeads}',
          AppColors.danger,
        ),
      ],
    );
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, _) {
                ...
                if (idx < 0 || idx >= data.monthLabels.length)
        ...
        barTouchData: BarTouchData(
          touchTooltipData: BarTouchTooltipData(
            getTooltipItem: (group, _, rod, __) {
              ...
              String label;
              if (v >= 100000)
                label = '₹${(v / 100000).toStringAsFixed(1)}L';
              else if (v >= 1000)
                label = '₹${(v / 1000).toStringAsFixed(1)}k';
              else
